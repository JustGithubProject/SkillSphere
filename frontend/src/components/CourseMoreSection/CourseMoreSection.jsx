                ...
                <div className="container">
                    <div className="row">
                        <div className="owl-carousel col-12 nonloop-block-14">
                            {[
                                { imgSrc: 'images/img_1.jpg', price: '$20', title: 'Study Law of Physics', students: '2,193', comments: '2' },
                                { imgSrc: 'images/img_2.jpg', price: '$99', title: 'Logo Design Course', students: '2,193', comments: '2' },
                                { imgSrc: 'images/img_3.jpg', price: '$99', title: 'JS Programming Language', students: '2,193', comments: '2' },
                                { imgSrc: 'images/img_4.jpg', price: '$20', title: 'Study Law of Physics', students: '2,193', comments: '2' },
                                { imgSrc: 'images/img_5.jpg', price: '$99', title: 'Logo Design Course', students: '2,193', comments: '2' },
                                { imgSrc: 'images/img_6.jpg', price: '$99', title: 'JS Programming Language', students: '2,193', comments: '2' }
                            ].map((course, index) => (
                                <div className="course bg-white h-100 align-self-stretch" key={index}>
                                    <figure className="m-0">
                                        <a href="course-single.html">
                                            <img src={course.imgSrc} alt="Course" className="img-fluid" />
                                        </a>
                                    </figure>
...
export default CourseMoreSection;
